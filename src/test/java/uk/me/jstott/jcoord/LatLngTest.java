...
public class LatLngTest {
    ...
    public void testToMGRSRef() {
        /*
         * Note that no tests are done here for converting an
         * latitude/longitude to
         * MGRS reference because the conversion will first convert the
         * latitude/longitude to a UTM reference and then convert that to an
         * MGRS
    ...
    public void testToDMSString6() {
        ...
        assertEquals("10 15 25.199999999998823 N 10 15 25.199999999998823 E",
            ll.toDMSString());
    }
    ...
    public void testToDMSString7() {
        LatLng ll = new LatLng(-10.257, -10.257);
        assertEquals("10 15 25.199999999998823 S 10 15 25.199999999998823 W",
            ll.toDMSString());
    }
    ...
    /*
     * Test method for 'uk.me.jstott.jcoord.LatLng.azimuth()'
     */
    public void testAzimuth() {
        LatLng latLngFrom = new LatLng(51.1915333, 6.8515167);
        LatLng latLngTo = new LatLng(51.1907500, 6.8499500);
        double a = latLngFrom.azimuth(latLngTo);
        assertEquals(4.039033340143817, a, 0.005);
        assertEquals(231.41956370286857, Math.toDegrees(a), 0.005);
    }
}
